...
//                Type[] typeArguments = GenericTypeResolver.resolveTypeArguments(clazz, View.class);// 不兼容 solon
                Type[] typeArguments = GenericUtil.resolveTypeArguments(clazz, View.class);
