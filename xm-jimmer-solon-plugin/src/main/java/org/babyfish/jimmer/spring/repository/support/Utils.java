...
//            );
//        }
        if (!(implementor.getConnectionManager() instanceof SolonConnectionManager)) {
            throw new IllegalArgumentException(
                    "The connection manager of sql client must be instance of \"" +
...
//        if (!(implementor.getTransientResolverProvider() instanceof SpringTransientResolverProvider)) { // 不兼容 solon
        if (!(implementor.getTransientResolverProvider() instanceof SolonTransientResolverProvider)) {
            throw new IllegalArgumentException(
...
//        if (slaveConnectionManager != null && !(slaveConnectionManager instanceof SpringConnectionManager)) { // 不兼容 solon
        if (slaveConnectionManager != null && !(slaveConnectionManager instanceof SolonConnectionManager)) {
            throw new IllegalArgumentException(
                    "The slave connection manager of sql client must be null or instance of \"" +
//                            SpringConnectionManager.class.getName() + // 不兼容 solon
                            SolonConnectionManager.class.getName() +
                            "\""
            );
        }
