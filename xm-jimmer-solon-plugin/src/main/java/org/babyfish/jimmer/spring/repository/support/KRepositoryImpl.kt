...
//            GenericTypeResolver.resolveTypeArguments(this.javaClass, JRepository::class.java) // 不兼容 solon
              GenericUtil.resolveTypeArguments(this.javaClass, JRepository::class.java)
